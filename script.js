...
const quizData = [
  ...
  {
    question:
      'Какой частотный диапазон может использоваться в радиорелейной связи для работы в городской среде?',
